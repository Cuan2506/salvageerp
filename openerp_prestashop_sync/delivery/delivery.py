            ...
            for openerp_data in self.get_openerp_data(cr,uid, shop_id,
                ...
                if search_field:
                    ...
                    try:
                        ...
                        self._logger.error(_("Erro in Eval of search field"))
                ...
                if openerp_id:
                    ...
                    self.write(cr, uid, [openerp_id], openerp_data,
                               context=context)
                    self._logger.info(_("Record Write for %s opener id %s External id %s"%(
                    ...
                    try:
                        ...
                        self._logger.info(_("Record created for %s opener id %s External id %s"%(
                                                          self._name,openerp_id,ext_id)))
                    except Exception as e:
                        self._logger.error(_("Error in Creating new %s Values are %s error is %s"%(
