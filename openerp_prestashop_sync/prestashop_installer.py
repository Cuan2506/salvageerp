...
class prestashop_installer(osv.osv_memory):
    ...
    _columns = {
                ...
                'prestashop_config_path':fields.char('Configuration File Path',
                             size=256,
                             required=True,
                             help="Configuration path of prestashop mapping, BY defautl it's in openerp_prestashop_sync/openerp.conf"),
...
#                'prestashop_config_path': _get_path,
    ...
    def test_connection(self, cr, uid, ids, context={}):
        ...
        if shop_data['prestashop_config_path'] and not os.path.exists(shop_data['prestashop_config_path']):
    ...
    def execute(self, cr, uid, ids, context={}):
        ...
        shop_obj.write(cr, uid, shop_id[0], vals)
        shop_obj.import_language(cr, uid, [shop_id[0]], context=context) 
